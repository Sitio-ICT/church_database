...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Support -->
            <li class="nav-item ">
                <a class="nav-link" href="client_view.php?user=">
                    <i class="fas fa-user"></i>
                    <span>Profile</span></a>
            </li>
            <?php
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="support_ticket.php?view=<?php echo $supportid ?>&status=1">
                                    ...
                                    <div>
                                        ...
                                        <i class='far fa-circle' style='font-size: 22px; color:yellow'></i>  <span style="color: yellow">Answered</span>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="">
                                    ...
                                    <div>
                                        <div class="small text-gray-500"></div>
                                        <i class='far fa-circle' style='font-size: 22px; color:yellow'></i> 
                                    </div>
                                </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; <?php echo date('Y') ?> Holy Family Catholic Church. All rights reserved</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
