...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        $findChurchSacraments = countRecords('sacraments_recieved');
        // ddA($Donation);
        if ($user_type == "admin") {
        ?>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total Sacraments Given</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo number_format($findChurchSacraments)
                                                                                        ?></div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
